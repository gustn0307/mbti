// export const : 변수, 함수, 배열, 객체 등의 상수를 다른 파일에서 사용할 수 있도록
//                네임드 익스포트(Named Export) 방식으로 내보내는 구문
// 내보낸 이름과 동일한 이름으로 {}를 사용하여 가져옴
export const questions = [
  ...
  },
  {
    ...
    choices: [
      {
        text: "일하면서 많이 힘들었나?<br>내가 좀 더 챙겨줄걸.",
        value: "f",
      },
      {
        text: "아 이직하나?<br>퇴사하고 뭐하냐고 물어봐야지.",
        value: "t",
      },
    ],
  },
